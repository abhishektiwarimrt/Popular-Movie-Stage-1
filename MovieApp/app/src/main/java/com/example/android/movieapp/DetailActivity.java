...
public class DetailActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if(intent !=null && intent.hasExtra(Movie.EXTRA_MOVIE)){
            ...
            ((TextView)findViewById(R.id.textview_movie_title)).setText(movie.title);
            ((TextView)findViewById(R.id.textview_movie_rating)).setText(movie.getRating());
            ((TextView)findViewById(R.id.textview_movie_overview)).setText(movie.overview);
            ((TextView)findViewById(R.id.textview_release_date)).setText(movie.release_date);


            Uri posterUri = movie.posterUri(getString(R.string.api_poster_default_size));
            Picasso.with(this)
                    .load(posterUri)
